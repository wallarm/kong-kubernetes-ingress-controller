...
# Helm 3
$ helm install --set ingressController.installCRDs=false <INGRESS_CONTROLLER_NAME> wallarm/kong -n <KUBERNETES_NAMESPACE> -f <PATH_TO_VALUES>
...
[dockerhub-kic]: https://hub.docker.com/r/wallarm/kong-kubernetes-ingress-controller
